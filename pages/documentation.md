...
### Page Full Width
If you want full control of styling a page, than use the [page fullwidth template]({{ site.url }}/design/page-fullwidth/). To set up a grid, just use the [foundation grid system](https://foundation.zurb.com/docs/components/grid.html).
