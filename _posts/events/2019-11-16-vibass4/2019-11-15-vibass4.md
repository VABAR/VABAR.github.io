...
2. The [second part]({{ site.url }}/events/vibass4-course/) is dedicated to an __issue of current interest in Bayesian research__. 
	...
	This edition is dedicated to __Bayesian computing with [R-INLA](https://www.r-inla.org/)__.

	This [12 h course]({{ site.url }}/events/vibass4-course/) is provided by [__Håvard Rue__](https://cemse.kaust.edu.sa/bayescomp/people/person/haavard-rue), founder of the [`INLA`](https://www.r-inla.org/) development team, Professor of Statistics and Principal Investigator of the Bayesian Computational Statistics and Modeling ([BAYESCOMP](https://cemse.kaust.edu.sa/bayescomp)) group, King Abdullah University of Science and Technology ([KAUST](https://kaust.edu.sa/)) and Janet van Niekerk, Post-Doctoral fellow In Statistics at KAUST.
...
-   Wednesday 14 and Thursday 15:\
    Bayesian computing with [R-INLA](https://www.r-inla.org/) (12 hours)\
    Håvard Rue and Janet van Niekerk

-   Friday 16: Fourth València International Bayesian Analysis
    Summer School Workshop

![Schedule]({{ site.url }}/assets/vibass4/schedule.png)
...
<!--
- [Registration form](https://congresos.adeituv.es/VIBASS4/) 
-->
