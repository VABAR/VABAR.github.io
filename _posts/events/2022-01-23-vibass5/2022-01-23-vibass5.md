...
2. The [second part]({{ site.url }}/events/vibass5-course/) is dedicated to an __issue of current interest in Bayesian research__. 
	...
	This edition is dedicated to __spatial and spatio-temporal models with the [R-INLA package](https://www.r-inla.org/)__.
...
-   Wednesday 20 and Thursday 21:\
    spatial and spatio-temporal models with the [R-INLA package](https://www.r-inla.org/) (12 hours)\
...
<!--
- [Registration form](https://congresos.adeituv.es/VIBASS5/) 
-->
